...
//    private IEnumerable<Author> GetAuthorsFromFile(string contentRootPath, ILogger<TradingContextSeed> logger)
//    {
...
//    private IEnumerable<Publisher> GetPublishersFromFile(string contentRootPath, ILogger<TradingContextSeed> logger)
//    {
...
//    private IEnumerable<BookSample> GetBookSamplesFromFile(string contentRootPath, CatalogContext context, ILogger<TradingContextSeed> logger)
//    {
