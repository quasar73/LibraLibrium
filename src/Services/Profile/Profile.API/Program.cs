...
using LibraLibrium.Services.Profile.API.Infrastructure;
    ...
    public static int Main(string[] args)
    {
        ...
        try
        {
            ...
            host.MigrateDbContext<ProfileContext>((context, services) =>
            {
                ...
                var logger = services.GetService<ILogger<ProfileContextSeed>>()!;

                new ProfileContextSeed().SeedAsync(context, env, logger).Wait();
            });
